...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route('teacher.profile.update') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                @if($user->profile_picture)
                    <div style="margin-top: 1rem;">
                        <button type="button" class="btn btn-danger btn-sm" onclick="if(confirm('Remove profile picture?')) { document.getElementById('remove-teacher-picture-form').submit(); }">
            ...
            <div class="form-group">
                ...
                <div style="background: #f8f9fa; padding: 1rem; border-radius: 4px;">
                    ...
                    <p style="margin: 0.5rem 0;"><strong>Courses Teaching:</strong> {{ $user->courses->count() }}</p>
                </div>
            </div>
        ...
        @if($user->profile_picture)
            <form id="remove-teacher-picture-form" action="{{ route('teacher.profile.remove-picture') }}" method="POST" style="display:none;">
                @csrf
                @method('DELETE')
            </form>
        @endif
